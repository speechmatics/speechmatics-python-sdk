...
class SileroVAD:
    ...
    def __init__(
        ...
        Args:
            ...
            silence_duration_ms: Duration of consecutive silence (in ms) before considering speech ended.
            on_state_change: Optional callback invoked when VAD state changes (speech <-> silence).
        """

        self._is_initialized: bool = False
        self._threshold: float = threshold
        self._silence_duration_ms: float = silence_duration_ms
        ...
        window_chunks = int(silence_duration_ms / SILERO_CHUNK_DURATION_MS) + 1
